...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { active: @artwork.active, description: @artwork.description, title: @artwork.title } }
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { active: @artwork.active, description: @artwork.description, title: @artwork.title } }
